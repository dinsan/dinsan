...
Interested in **AI-assisted development, LLM applications, AI APIs, prompt engineering, RAG, and integrating AI capabilities into modern web applications**.
...
* **Clean Architecture** — OOP, SOLID, DDD, and maintainable system design
* **Backend Engineering** — Java, Python, Spring Boot, Node.js, Flask, APIs, microservices, and distributed systems
* **Modern Frontend** — React, Next.js, TypeScript, and JavaScript
* **Database Engineering** — SQL, PostgreSQL, MySQL, SQLAlchemy, Redis, and data modeling
* **AI Engineering** — LLMs, AI APIs, RAG, AI-powered applications, and developer tools
* **Performance** — Concurrency, scalability, memory optimization, and high-throughput systems
* **Code Quality** — TDD, automated testing, code reviews, and continuous improvement

## 🚀 Currently Exploring

* 🤖 AI-powered applications and LLM integrations
* 🧠 RAG and AI agents
* ☕ Modern Java 17/21 and Spring Boot
* 🐍 Python, Flask, and SQLAlchemy backend architecture
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/fulldeveloperdinsan)
